...
namespace SMMS.Repositories.NghiaHT.Basic;

public class GenericRepository<T> where T : class
{
    protected SU25_PRN232_SE1725_G2_SMMSContext _context;

    public GenericRepository()
    {
        _context ??= new SU25_PRN232_SE1725_G2_SMMSContext();
    }

    public GenericRepository(SU25_PRN232_SE1725_G2_SMMSContext context)
    {
        _context = context;
    }
